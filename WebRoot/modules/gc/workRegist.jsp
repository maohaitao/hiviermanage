...
<d:grid id="roleGrid" title="工时列表" height="365" queryForm="queryForm" model="gc/workRegist" autoQuery="false"
        pagerSize="100">
    <d:toolBar align="left">
        <d:gridButton afterAction="query" icon="DBFoundUI/images/page_attach.png" action="gc/workRegist.execute!regiest"
                      title="报工"/>
    </d:toolBar>
    <d:columns>
