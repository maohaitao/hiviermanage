...
<d:form id="queryForm" title="报工取消" labelWidth="80">
    <d:line columnWidth="0.33">
        <d:field name="project_id" options="projectStore" valueField="project_id" displayField="project_name"
                 anchor="85%" editor="combo" prompt="工程选择">
...
<d:grid id="roleGrid" title="工时列表" height="365" queryForm="queryForm" queryUrl="gc/workRegist.query!unRegist"
        autoQuery="true">
    <d:toolBar align="left">
        <d:gridButton afterAction="query" icon="DBFoundUI/images/page_attach.png"
                      action="gc/workRegist.execute!unRegiest" title="报工取消"/>
    </d:toolBar>
    <d:columns>
