...
<d:form id="queryForm" title="工程结算" labelWidth="80">
    <d:line columnWidth="0.33">
        <d:field name="project_id" required="true" options="projectStore" valueField="project_id"
                 displayField="project_name" anchor="85%" editor="combo" prompt="工程选择">
            <d:event name="select" handle="query"></d:event>
        </d:field>
        <d:field name="employee_id" options="employeeStore" valueField="employee_id" displayField="employee_name"
                 anchor="85%" editor="combo" prompt="工人选择">
            <d:event name="select" handle="query"></d:event>
        </d:field>
    </d:line>
</d:form>
...
<d:grid id="roleGrid" title="工时列表" height="380" queryForm="queryForm" model="gc/settlement" autoQuery="false"
        pagerSize="50">
    <d:toolBar>
