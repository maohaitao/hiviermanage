...
<d:form width="500" id="queryForm" title="工时补报" labelWidth="80">
    <d:line columnWidth="1">
        <d:field name="project_id" editable="false" required="true" options="projectStore" valueField="project_id"
                 displayField="project_name" anchor="85%" editor="combo" prompt="工程选择">
        </d:field>
    </d:line>
    <d:line columnWidth="1">
        <d:field name="employee_id" required="true" options="employeeStore" valueField="employee_id"
                 displayField="employee_name" anchor="85%" editor="combo" prompt="工人选择">
        </d:field>
    </d:line>
    <d:line columnWidth="1">
