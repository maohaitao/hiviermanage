...
<d:form id="headerForm" title="作业信息" labelWidth="80">
    <d:line columnWidth="0.5">
        <d:field name="tile" value="${headerStore[0].title}" readOnly="true" anchor="86%" editor="textfield"
                 prompt="作业题目"/>
        <d:field name="teacher_name" readOnly="true" value="${headerStore[0].teacher_name}" anchor="86%"
                 editor="textfield" prompt="布置老师"/>
    </d:line>
    <d:line columnWidth="0.5">
        <d:field name="class_id" readOnly="true" value="${headerStore[0].class_name}" anchor="86%" editor="textfield"
                 prompt="所对班级"/>
        <d:field name="status" value="${headerStore[0].status_name}" readOnly="true" anchor="86%" editor="textfield"
                 prompt="状态"/>
    </d:line>
    <d:line columnWidth="0.5">
        <d:field name="course_id" readOnly="true" value="${headerStore[0].course_name}" anchor="86%" editor="textfield"
                 prompt="学科选择"/>
        <d:field name="end_time" readOnly="true" value="${headerStore[0].end_time}" anchor="86%" editor="datefield"
                 prompt="完成时间"/>
    </d:line>
    <d:line columnWidth="1">
        <d:field name="description" readOnly="true" value="${headerStore[0].description}" anchor="93%" editor="textarea"
                 prompt="描述"/>
    </d:line>
</d:form>
