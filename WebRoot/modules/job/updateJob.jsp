...
<d:form id="queryForm" height="200" labelWidth="80">
    <d:line columnWidth="0.5">
        <d:field name="tile" value="${headerStore[0].title}" readOnly="true" width="210" editor="textfield"
                 prompt="作业题目"/>
        <d:field name="teacher_name" readOnly="true" value="${headerStore[0].teacher_name}" width="210"
                 editor="textfield" prompt="布置老师"/>
    </d:line>
    <d:line columnWidth="0.5">
        <d:field name="class_id" value="${headerStore[0].class_id}" required="true" options="class_ds"
                 valueField="class_id" displayField="class_name" width="210" editor="combo" prompt="所对班级">
            <d:event name="select" handle="resetCourse"></d:event>
        </d:field>
        <d:field name="status" value="${headerStore[0].status_name}" readOnly="true" width="210" editor="textfield"
                 prompt="状态"/>
    </d:line>
    <d:line columnWidth="0.5">
        <d:field id="course_cb" name="course_id" value="${headerStore[0].course_id}" required="true" options="course_ds"
                 valueField="course_id" displayField="course_name" width="210" editor="combo" prompt="课程选择"/>
        <d:field name="end_time" value="${headerStore[0].end_time}" required="true" width="210" editor="datefield"
                 prompt="完成时间"/>
    </d:line>
    <d:line columnWidth="1">
        <d:field name="description" height="80" value="${headerStore[0].description}" width="555" editor="textarea"
                 prompt="描述"/>
    </d:line>
</d:form>
