...
<script type="text/javascript">
    ...
    function openUpdateWindow(id, line_id) {
        ...
        url = "${basePath}" + url;
        DBFound.open("my_job_window", "作业提交", 780, 460, url, function () {
            jobGrid_ds.reload();
        });
    }
...
<d:form id="queryForm" title="我的当前作业" labelWidth="90">
    <d:line columnWidth="0.33">
        ...
        <d:field name="course_id" options="course_ds" valueField="course_id" displayField="course_name" editor="combo"
                 prompt="课程选择"/>
        <d:field name="status" editor="combo" options="statusStore" displayField="status_name" valueField="status_code"
                 prompt="作业状态"/>
    </d:line>
    <d:line columnWidth="0.33">
...
<d:grid id="jobGrid" title="作业列表" height="350" queryForm="queryForm" queryUrl="modules/job/myJobQuery.jsp"
        selectable="true" autoQuery="true">
    <d:columns>
