...
<d:form id="queryForm" title="作业新增" bindTarget="job_ds" height="260" width="700" labelWidth="80">
    ...
    <d:line columnWidth="0.5">
        <d:field name="class_id" required="true" options="class_ds" valueField="class_id" displayField="class_name"
                 width="210" editor="combo" prompt="所对班级">
    ...
    <d:line columnWidth="0.5">
        <d:field id="course_cb" name="course_id" required="true" options="course_ds" valueField="course_id"
                 displayField="course_name" width="210" editor="combo" prompt="课程选择"/>
