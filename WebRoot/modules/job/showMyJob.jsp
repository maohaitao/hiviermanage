...
<d:form title="作业信息" labelWidth="80">
    ...
    <d:line columnWidth="0.33">
        ...
        <d:field name="course_id" readOnly="true" value="${headerStore[0].course_name}" editor="textfield"
                 prompt="学科选择"/>
        <d:field name="end_time" readOnly="true" value="${headerStore[0].end_time}" editor="datefield" prompt="完成时间"/>
    </d:line>
    <d:line columnWidth="1">
        <d:field name="description" anchor="95.7%" readOnly="true" value="${headerStore[0].description}"
                 editor="textarea" prompt="描述"/>
    </d:line>
</d:form>

<d:form title="提交信息" labelWidth="80">
    <d:line columnWidth="0.8">
        <d:field name="description" anchor="98%" value="${lineStore[0].description}" readOnly="true" editor="textarea"
                 prompt="提交信息"/>
...
<d:form title="审批信息" labelWidth="80">
    ...
    <d:line columnWidth="1">
        <d:field name="teacher_comment" anchor="95.7%" value="${lineStore[0].teacher_comment}" readOnly="true"
                 editor="textarea" prompt="教师评语"/>
    </d:line>
</d:form>
<d:buttonGroup>
