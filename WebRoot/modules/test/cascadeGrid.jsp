...
<d:form id="queryForm" title="访问控制" labelWidth="120">
    ...
    <d:line columnWidth="0.5">
        <d:field name="ae" displayField="text" parentField="pid" valueField="id" anchor="85%" editor="treecombo"
                 options="treedata" prompt="下拉tree选择框">
        </d:field>
        <d:field name="area_name" editor="lov" lovUrl="modules/test/treeLov.jsp" lovHeight="440" lovWidth="340"
                 prompt="区域选择">
...
<d:panel title="控制列表" height="388">
    ...
    <d:grid id="acGrid" height="360" style="width:70%;position:absolute;left:0px;margin:0px" queryForm="queryForm"
            singleSelect="true" model="sys/accessControl" autoQuery="true">
        <d:toolBar>
        ...
        <d:columns>
            ...
            <d:column name="enable_flag" required="true" editor="combo" options="statusStore" displayField="status_name"
                      valueField="status_code" prompt="作用域" width="100"/>
    ...
    <d:grid id="assignGrid" height="360" navBar="false" style="margin:0px;margin-left:70%"
            queryUrl="sys/pagerAssign.query" model="sys/pagerAssign">
        <d:toolBar>
        ...
        <d:columns>
            <d:column name="function_id" required="true" options="functionStore" editor="combo"
                      displayField="function_des" valueField="function_id" prompt="分配功能" width="350"/>
        </d:columns>
    </d:grid>
