...
<div style="width:220px;left:0px;top:0px;position:absolute;">
    <d:tree id="menuTree" title="树测试" bindTarget="treedata" idField="id" parentField="pid" displayField="text"
            height="$D.getFullHeight('menuTree')">
...
<div style="margin-left:220px">
    ...
    <d:grid id="roleGrid" title="角色列表" isCellEditable="isCellEditable" height="$D.getFullHeight('roleGrid')"
            queryForm="queryForm" model="sys/role" autoQuery="true">
        <d:toolBar>
