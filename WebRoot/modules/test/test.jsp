...
<body>
<d:grid queryUrl="test/user.query!enabled" title="启用用户列表" style="width:220px;left:0px;top:0px;position:absolute;"
        id="userGrid1" height="300" autoQuery="true" navBar="false">
    <d:columns>
...
<d:grid queryUrl="test/user.query!disabled" style="left:280px;width:220px;position:absolute;" title="未启用用户列表"
        id="userGrid2" height="300" autoQuery="true" navBar="false">
    <d:columns>
        <d:column name="user_code" prompt="用户编号" width="120"/>
        <d:column name="user_name" prompt="用户名" width="120"/>
    </d:columns>
