...
<d:treeGrid id="treegrid" autoQuery="true" viewForm="viewForm" queryForm="queryForm" title="功能树表" idField="id"
            parentField="pid" showCheckBox="true" queryUrl="menu.query" height="$D.getFullHeight('treegrid')-120">
    <d:toolBar>
