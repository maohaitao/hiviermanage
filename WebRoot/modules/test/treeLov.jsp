...
<script type="text/javascript">
    function submit() {
        parent.Ext.getCmp("${param.windowId}").commit({
            area_name: areaTree.getSelectedText(),
            area_id: areaTree.getSelectedId()
        });
    }
    function clear() {
...
<d:tree id="areaTree" showCheckBox="true" bindTarget="treedata" idField="area_id" parentField="parent_id"
        displayField="area_name" width="300" height="350">
