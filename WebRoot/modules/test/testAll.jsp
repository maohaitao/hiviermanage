...
<d:form id="queryForm" title="功能管理" labelWidth="80">
    <d:line columnWidth="0.33">
        ...
        <d:field name="module_id" options="moduleStore" valueField="module_id" displayField="module_name" anchor="85%"
                 editor="lovcombo" prompt="从属模块"/>
    </d:line>
    <d:line columnWidth="0.33">
...
<d:grid id="functionGrid" title="功能列表" viewForm="viewForm" queryForm="queryForm" model="sys/function" autoQuery="true"
        height="$D.getFullHeight('functionGrid')-150">
    <d:toolBar>
...
<d:tabs>
    <d:tab title="信息修改">
        <d:form id="viewForm" labelWidth="100">
            <d:line columnWidth="0.33">
                <d:field id="cod_f" required="true" name="function_code" upper="true" anchor="85%" editor="textfield"
                         prompt="功能编号"/>
                <d:field id="des_f" required="true" name="function_des" anchor="85%" editor="textfield" prompt="功能描述"/>
                <d:field name="module_des" required="true" hiddenName="function_module" options="moduleStore"
                         valueField="module_id" displayField="module_name" anchor="85%" editor="combo" prompt="从属模块"/>
            </d:line>
            <d:line columnWidth="0.33">
            ...
            <d:toolBar>
                ...
                <d:formButton id="save_bt" beforeAction="beforeAction" action="sys/function.execute!update"
                              afterAction="afterAction" title="保存" icon="DBFoundUI/images/save.gif"></d:formButton>
            </d:toolBar>
        </d:form>
    </d:tab>
