...
<d:panel height="400" title="功能列表">
    <d:grid id="functionGrid" height="372" style="width:70%;position:absolute;left:0px;top:0px;margin:0px"
            viewForm="viewForm" model="sys/function" autoQuery="true">
        <d:toolBar>
    ...
    <d:form id="viewForm" style="margin:0px;margin-left:70%;" labelWidth="90">
        <d:line columnWidth="1">
            <d:field id="cod_f" required="true" name="function_code" upper="true" anchor="95%" editor="textfield"
                     prompt="功能编号"/>
        </d:line>
        <d:line columnWidth="1">
        ...
        <d:line columnWidth="1">
            <d:field name="module_des" required="true" hiddenName="function_module" options="moduleStore"
                     valueField="module_id" displayField="module_name" anchor="95%" editor="combo" prompt="从属模块"/>
        </d:line>
        <d:line columnWidth="1">
