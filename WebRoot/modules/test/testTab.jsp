...
<script type="text/javascript">
    function save() {
        alert('OK');
        if ($D.getTab("userDefine").reset) {
            $D.getTab("userDefine").reset();
        }
    }
</script>
<body>
...
<d:tabs>
    <d:tab height="450" title="功能定义">
        <d:treeGrid id="treegrid" autoQuery="true" title="功能树表" idField="id" parentField="pid" showCheckBox="true"
                    queryUrl="menu.query" height="350">
            <d:toolBar>
    ...
    <d:tab height="450" title="角色定义">
        <d:tree style="width:220px;position:absolute;left:0px;top:0px" id="menuTree" title="树测试" bindTarget="treedata"
                idField="id" parentField="pid" displayField="text" height="440">
        </d:tree>
