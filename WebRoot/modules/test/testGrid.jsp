...
<d:form id="queryForm" title="复合表头测试" labelWidth="80">
    <d:line columnWidth="0.33">
        ...
        <d:field name="status_code" width="150" editor="combo" options="statusStore" displayField="status_name"
                 valueField="status_code" prompt="状态"/>
    </d:line>
    <d:line columnWidth="0.33">
        <d:field name="role_id" editor="combo" options="roleStore" displayField="role_name" valueField="role_id"
                 prompt="角色" width="150"/>
...
<d:grid id="userGrid" title="用户列表" height="370" isCellEditable="isCellEditable" queryForm="queryForm" plugins="group"
        model="sys/user" autoQuery="true">
    <d:toolBar>
        <d:gridButton type="add"/>
        <d:gridButton type="save"/>
    </d:toolBar>
    <d:columns>
        <d:column name="user_code" upper="true" required="true" editor="lov" lovHeight="500" lovWidth="550"
                  lovUrl="sys/userLov.jsp?lov=1" prompt="用户编号" width="120">
        ...
        <d:column name="role_id" editor="combo" options="roleStore" displayField="role_name" valueField="role_id"
                  prompt="角色" width="140"/>
        <d:column name="status" required="true" editor="combo" options="statusStore" displayField="status_name"
                  valueField="status_code" prompt="状态" width="100"/>
