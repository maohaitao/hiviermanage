...
<div style="width: 40%; position: absolute;">
    <d:pieChart title="月考成绩饼图" dataLabel="true" bindTarget="pieStore" height="450" valueField="total_num"
                displayField="grade"/>
</div>
...
<div style="width: 100%; top:460px; position: absolute;">
    <d:lineChart style="margin-top:0px" title="月考分析折线图" yAxis="yAxis" xAxis="xAxis" height="350" bindTarget="barStore"/>
</div>
</body>
</html>
