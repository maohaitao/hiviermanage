...
<d:grid id="courceGrid" title="学科列表" height="365" isCellEditable="isCellEditable" queryForm="queryForm"
        model="fnd/branch" autoQuery="true">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="enable_flag" required="true" editor="combo" options="statusStore" displayField="status_name"
                  valueField="status_code" prompt="状态" width="80"/>
