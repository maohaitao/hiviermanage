...
<d:grid id="studentGrid" title="学生列表" height="365" isCellEditable="isCellEditable" queryForm="queryForm"
        model="fnd/student" autoQuery="true">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="class_id" required="true" options="class_ds" valueField="class_id" displayField="class_name"
                  width="150" editor="combo" prompt="班级"/>
