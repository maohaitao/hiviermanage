...
<d:form title="查询条件" id="queryForm" labelWidth="80">
    <d:line columnWidth="0.5">
        <d:field name="user_code" upper="true" width="180" editor="textfield" prompt="用户编号">
...
<d:grid title="用户列表" id="userGrid" singleSelect="true" queryForm="queryForm" height="300" model="sys/user"
        autoQuery="true" pagerSize="10">
    <d:columns>
