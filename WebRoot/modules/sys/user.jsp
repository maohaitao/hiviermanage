...
<d:form id="queryForm" title="查询条件" labelWidth="80">
    <d:line columnWidth="0.33">
        <d:field name="user_code" upper="true" anchor="85%" editor="textfield" prompt="用户编号">
            <d:event name="enter" handle="query"/>
        </d:field>
        <d:field name="user_name" anchor="85%" editor="textfield" prompt="用户名">
            <d:event name="enter" handle="query"/>
        </d:field>
        <d:field name="status_code" anchor="85%" editor="combo" options="statusStore" displayField="status_name"
...
<d:grid id="userGrid" title="用户列表" height="365" model="sys/user" isCellEditable="isCellEditable" queryForm="queryForm"
        autoQuery="true">
    <d:toolBar>
    ...
    <d:columns>
        <d:column name="user_code" sortable="true" upper="true" required="true" editor="textfield" prompt="用户编号"
                  width="120"/>
