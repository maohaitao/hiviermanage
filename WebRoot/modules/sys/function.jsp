...
<d:grid id="functionGrid" height="365" title="功能列表" isCellEditable="isCellEditable" queryForm="queryForm"
        model="sys/function" autoQuery="true">
    <d:toolBar>
    ...
    <d:columns>
        <d:column name="function_code" sortable="true" upper="true" required="true" editor="textfield" prompt="功能编号"
                  width="100"/>
        <d:column name="function_des" sortable="true" required="true" editor="textfield" prompt="功能描述" width="120"/>
        <d:column name="image" editor="textfield" prompt="图标" width="100"/>
        <d:column name="jsp_pager" required="true" editor="textfield" prompt="对应jsp页面" width="160"/>
        <d:column name="priority" sortable="true" align="right" required="false" editor="numberfield" prompt="优先级"
                  width="60"/>
        <d:column name="function_module" required="true" options="moduleStore" valueField="module_id"
                  displayField="module_name" width="130" editor="combo" prompt="从属模块"/>
