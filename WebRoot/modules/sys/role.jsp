...
<d:form id="queryForm" title="查询条件" labelWidth="80">
    <d:line columnWidth="0.33">
        ...
        <d:field name="user_name" anchor="85%" editor="lov" lovUrl="modules/sys/userLov.jsp" lovHeight="445"
                 lovWidth="600" prompt="最后经办人">
...
<d:grid id="roleGrid" title="角色列表" height="365" isCellEditable="isCellEditable" queryForm="queryForm"
        queryUrl="sys/role.do!query" autoQuery="true">
    <d:toolBar>
        <d:gridButton type="add"/>
        <d:gridButton type="save" action="sys/role.do!save"/>
        <d:gridButton type="delete" action="sys/role.do!delete"/>
    </d:toolBar>
    <d:columns>
        <d:column name="role_code" sortable="true" upper="true" required="true" editor="textfield" prompt="角色编号"
                  width="130"/>
