...
<d:form id="queryForm" title="权限分配" labelWidth="80">
    <d:line columnWidth="0.5">
        <d:field name="role_id" required="true" options="role_ds" valueField="role_id" displayField="role_name"
                 width="200" editor="combo" prompt="角色选择">
            <d:event name="select" handle="query"/>
        </d:field>
        <d:field name="module_id" options="moduleStore" valueField="module_id" displayField="module_name" width="200"
                 editor="combo" prompt="模块">
            <d:event name="select" handle="query"/>
        </d:field>
    </d:line>
</d:form>
...
<d:grid id="roleGrid" queryUrl="sys/power.query" title="功能列表" queryForm="queryForm" height="380" autoQuery="false"
        pagerSize="100">
    <d:toolBar>
    ...
    <d:columns>
        ...
        <d:column name="enable_flag" editor="combo" options="statusStore" displayField="status_name"
                  valueField="status_code" prompt="是否启用" width="100"/>
