...
<d:form id="queryForm" title="查询条件" labelWidth="80">
    <d:line columnWidth="0.33">
        ...
        <d:field name="user_name" anchor="85%" editor="lov" lovUrl="modules/sys/userLov.jsp" lovHeight="440"
...
<d:grid id="moduleGrid" height="365" title="模块列表" isCellEditable="isCellEditable" queryForm="queryForm"
        model="sys/module" autoQuery="true">
    <d:toolBar>
