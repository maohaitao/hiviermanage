...
<d:form id="uploadform" title="请选择文件" width="700" labelWidth="70" fileUpload="true">
    <d:line columnWidth="0.5">
        <d:field columnWidth="0.7" readOnly="true" name="path" value="\${@prejectRoot}/" anchor="90%" required="true"
                 prompt="路径" editor="textfield">
...
<d:grid id="fileGrid" queryForm="uploadform" selectable="true" selectFirstRow="false" navBar="false" rowNumber="true"
        autoQuery="true" height="$D.getFullHeight('fileGrid')-30" queryUrl="manager/fileManager.execute!listFile">
    <d:toolBar>
