...
<d:form id="queryForm" title="查询条件" labelWidth="80">
    <d:line columnWidth="0.25">
        <d:field name="timefrom" anchor="95%" currentTime="-10" editor="datefield" prompt="费用日期从"/>
        <d:field name="timeto" anchor="95%" currentTime="-1" editor="datefield" prompt="费用日期到"/>
    </d:line>
</d:form>
...
<d:grid id="listGrid" title="GO桌面用户统计" queryForm="queryForm" forceFit="false"
        queryUrl="report/channelCountReport.execute" rowNumber="false" navBar="false" selectable="false"
        autoQuery="true" height="$D.getFullHeight('listGrid')">
    <d:columns>
