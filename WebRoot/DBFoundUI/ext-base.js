...
(function () {
    ...
    Ext.apply(k, {
        $isClass: true, callParent: function (e) {
            var t;
    ...
    k.prototype = {
        constructor: function () {
            ...
            var N, e = (N = this.callParent.caller) && (N.$previous || ((N = N.$owner ? N : N.caller) && N.$owner.superclass[N.$name]));
    ...
    Ext.apply(Ext, {
        ...
        createNamespace: function (R, O) {
            var e = Ext.namespaceCache, P = O ? R.substring(0, R.lastIndexOf(".")) : R, U = e[P], S, N, t, Q, T;
            if (!U) {
                U = Ext.global;
                if (P) {
                    T = [];
        ...
        getClassByName: function (N) {
            var O = N.split("."), e = Ext.global, P = O.length, t;
            for (t = 0; e && t < P; ++t) {
                e = e[O[t]]
            }
            return e || null
        ...
        namespace: function () {
            var O = arguments.length, P = 0, t, N, e, R, Q, S;
            for (; P < O; ++P) {
                e = arguments[P];
                R = arguments[P].split(".");
                S = window[R[0]];
        ...
        urlDecode: function (N, t) {
            ...
            var Q = {}, P = N.split("&"), R = decodeURIComponent, e, O;
...
(function () {
    ...
    Ext.lib.Event = function () {
        ...
        var x = {
            extAdapter: true, onAvailable: function (H, F, I, G) {
    ...
    Ext.lib.Ajax = function () {
        var g = ["Msxml2.XMLHTTP.3.0", "Msxml2.XMLHTTP"], d = "Content-Type";
