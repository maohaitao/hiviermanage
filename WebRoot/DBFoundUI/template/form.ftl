        ...
        items: [
            ...
            listeners: {
                    ...
                    <#list field.events as event>
                        <#if event.name =="enter">
                            specialKey: function (field, e) {
                                if (e.getKey() == Ext.EventObject.ENTER)${event.handle}(field, e);
                            },
                        <#else>
                ...
                keypress :function (t, e) {
                    DBFound.keypress(t, e, this);
                }
                ,
                blur:function () {
                    DBFound.blurUpper(this);
                }
                <#else>
                    <#list field.events as event>
                        <#if event.name =="enter">
                ...
                true,
                        style
                :"background:" + $D.FieldReadOnlyBackground,
                </#if>
                ...
                triggerClass : 'x-form-search-trigger', xtype
                :
                'trigger'
                ...
                inputType : "password", xtype
                :
                "textfield"
                <#elseif field.editor="file">
                inputType:'file', xtype
                :
                'textfield'
