...
<body>
<d:grid title="已用户列表" style="width:220px;left:0px;top:0px;position:absolute;" id="userGrid1" singleSelect="true"
        height="300" model="sys/user" autoQuery="true" pagerSize="10">
    <d:columns>
...
<d:grid style="left:280px;width:220px;position:absolute;" title="用户列表" id="userGrid2" singleSelect="true" height="300"
        model="sys/user" autoQuery="true" pagerSize="10">
    <d:columns>
        <d:column name="user_code" prompt="用户编号" width="120"/>
        <d:column name="user_name" prompt="用户名" width="120"/>
    </d:columns>
