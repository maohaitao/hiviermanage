<%@ page language="java" import="com.nfwork.dbfound.web.file.FileUploadUtil" pageEncoding="utf-8" %>
...
<d:form id="uploadform" title="请选择文件" labelWidth="70" fileUpload="true">
    <d:line columnWidth="0.5">
        <d:field columnWidth="0.7" name="file" id="file_cmp" anchor="90%" required="true" prompt="附 件"
                 editor="file"></d:field>
...
<d:grid id="fileGrid" title="附件列表" autoQuery="true" height="285"
        queryUrl="upload.query?pk_value=${param.pk_value}&table_name=${param.table_name}" model="upload">
    <d:toolBar>
